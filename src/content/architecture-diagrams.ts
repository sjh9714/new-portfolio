...
export const architectureDiagrams: Record<string, ArchitectureDiagramSpec> = {
  "concert-booking": {
    ...
    title: "Queue-bound reservation consistency",
    summary:
    ...
    nodes: [
      ...
      },
      {
        id: "postgres",
        label: "PostgreSQL",
        description: "좌석, 예약, 결제 상태의 최종 진실 원천입니다.",
        kind: "database",
        sourceOfTruth: true,
    ...
    edges: [
      {
        ...
        from: "client",
        to: "queue",
        label: "queue token issue / validate",
        kind: "sync",
      },
      {
        id: "reserve-seat",
        from: "queue",
        to: "reservation",
        label: "reserved request with idempotency key",
        kind: "transaction",
        evidenceLabel: "Hot Seat Contention",
      },
      {
        ...
        from: "reservation",
        to: "payment",
        label: "payment / cancel / expire race",
        kind: "transaction",
        evidenceLabel: "Testcontainers scenarios",
      },
      {
        ...
        from: "payment",
        to: "outbox",
        label: "commit domain change and event intent",
        kind: "transaction",
      },
      {
        id: "publish-event",
    ...
    boundaries: [
      {
        id: "reservation-tx",
        label: "Reservation transaction boundary",
        kind: "transaction",
        nodeIds: ["reservation", "payment", "outbox", "postgres"],
      },
      {
        id: "event-boundary",
        label: "Async publish / consume boundary",
        kind: "async",
        nodeIds: ["outbox", "kafka", "consumer"],
      },
      {
        id: "failure-boundary",
        label: "Publish or consumer failure path",
        kind: "failure",
        nodeIds: ["outbox", "kafka", "consumer"],
      },
      {
        id: "truth-boundary",
        label: "DB-backed final consistency",
        kind: "source",
  ...
  "realtime-chat": {
    slug: "realtime-chat",
    title: "Room-keyed realtime messaging",
    summary:
    ...
    nodes: [
      ...
      },
      {
        id: "message-db",
        label: "Message DB",
        description: "message와 read state의 최종 진실 원천입니다.",
        kind: "database",
        sourceOfTruth: true,
    ...
    edges: [
      {
        ...
        from: "client",
        to: "app1",
        label: "STOMP subscribe authorization",
        kind: "sync",
      },
      {
        id: "publish",
      ...
      },
      {
        ...
        from: "consumer",
        to: "message-db",
        label: "message + read state persist",
        kind: "transaction",
        evidenceLabel: "N+1 query removal",
      },
      {
      ...
      },
      {
        ...
        label: "send-to-receive sampling",
        kind: "sync",
        evidenceLabel: "Send-to-receive latency",
      },
    ],
    boundaries: [
      {
        id: "ws-boundary",
        label: "WebSocket instance boundary",
        kind: "async",
        nodeIds: ["app1", "app2", "redis"],
      },
      {
        id: "kafka-boundary",
        label: "Kafka async ordering boundary",
        kind: "async",
        nodeIds: ["app1", "kafka", "consumer"],
      },
      {
        id: "db-truth",
        label: "Message source of truth",
        kind: "source",
        nodeIds: ["message-db"],
      },
      {
        id: "pending-boundary",
        label: "Pending benchmark boundary",
        kind: "failure",
  ...
  "ai-usage-billing-gateway": {
    ...
    title: "Tenant-aware billing consistency",
    summary:
    ...
    edges: [
      ...
      },
      {
        ...
        from: "invoice",
        to: "ledger",
        label: "append charge / payment entries",
        kind: "transaction",
        evidenceLabel: "Append-only ledger invariant",
      },
      {
    ...
    boundaries: [
      {
        id: "tenant-boundary",
        label: "Tenant / key security boundary",
        kind: "transaction",
        nodeIds: ["user-api", "api-key", "gateway"],
      },
      {
        id: "billing-boundary",
        label: "Billing transaction boundary",
        kind: "transaction",
        nodeIds: ["usage", "invoice", "ledger", "audit"],
      },
      {
        id: "webhook-boundary",
        label: "External webhook retry boundary",
        kind: "failure",
    ...
    callouts: [
      {
        label: "Duplicate is normal input",
        description:
  ...
  "msa-shop": {
    slug: "msa-shop",
    title: "Order compensation across services",
    summary:
    ...
    nodes: [
      ...
      },
      {
        ...
        description: "각 서비스 로컬 데이터의 진실 원천입니다.",
        kind: "database",
        sourceOfTruth: true,
      },
      {
    ...
    edges: [
      ...
      },
      {
        ...
        from: "order",
        to: "outbox",
        label: "local state + event intent",
        kind: "transaction",
        evidenceLabel: "SAGA compensation flow",
      },
      {
        ...
        from: "payment",
        to: "product",
        label: "payment failure compensation",
        kind: "compensation",
        evidenceLabel: "SAGA compensation flow",
      },
      {
